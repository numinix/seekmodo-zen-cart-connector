...
return [
    ...
    'changelog' => 'v1.3.50 (2026-08-09): SERP defaults to Seekmodo relevance (ignores injected name sort) and adds a Relevance sort option. See CHANGELOG.md.',
