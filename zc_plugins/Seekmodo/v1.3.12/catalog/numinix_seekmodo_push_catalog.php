...
foreach ($products as $row) {
    ...
    $inStock = function_exists('numinix_seekmodo_catalog_doc_live_in_stock')
        ? numinix_seekmodo_catalog_doc_live_in_stock($pid, (int)($row['products_quantity'] ?? 0))
        : ((int)($row['products_quantity'] ?? 0) > 0);
