...
return [
    ...
    'changelog' => 'v1.3.72 (2026-08-17): SERP live-stock ranking no longer hydrates full catalog docs for every hit (fixes 1GB OOM / HTTP 500 on broad queries). See CHANGELOG.md.',
