...
// All four files live INSIDE the plugin tree so the connector is fully
...
//   2. search lib  (defines numinix_seekmodo_run_search)
//   3. indexer lib (defines numinix_seekmodo_run_bulk_upsert)
//   4. events lib  (defines numinix_seekmodo_mirror_click / impression)
//
// Eager-load means the swap-points in Redline's class.search.php /
// transfer_products.php / ajax_search_log.php just call function_exists()
// and don't need to know the plugin's version-specific path.
