...
return [
    ...
    'changelog' => 'v1.3.54 (2026-08-10): Enhanced Native SERP when unpaired or trial_expired/unpaid (parity with local suggest). See CHANGELOG.md.',
