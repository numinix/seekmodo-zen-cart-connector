...
return [
    ...
    'changelog' => 'v1.3.61 (2026-08-12): Allow catalog indexing when locked_domain is an intentional nonprod host (demo/staging tenants). See CHANGELOG.md.',
