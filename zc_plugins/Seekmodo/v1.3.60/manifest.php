...
return [
    ...
    'changelog' => 'v1.3.60 (2026-08-12): Strip UTF-8 BOM from language packs and buffer pack includes so seekmodo:* metas stay in <head> (fixes empty suggest). See CHANGELOG.md.',
