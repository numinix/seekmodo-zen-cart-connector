...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall()
    {
        ...
        $this->addConfigurationKey('NUMINIX_SEEKMODO_RESTOCK_EXCLUDED_STATUS_IDS', [
            'configuration_title' => 'Seekmodo: Restock Excluded Order Status IDs',
            'configuration_value' => '',
            'configuration_description' => 'Comma-separated numeric Zen Cart order-status IDs that must not count toward restock demand (for example cancelled or refunded statuses). Numeric IDs make this work with localized status names.',
            'configuration_group_id' => $groupId,
            'sort_order' => 109,
        ]);
    ...
    protected function executeUninstall()
    {
        $this->deleteConfigurationKeys([
            ...
            'NUMINIX_SEEKMODO_RESTOCK_EXCLUDED_STATUS_IDS',
     ...
     */
    public function getConfigurationKeyDetails(
        string $key_name,
        bool $only_check_existence = false
    ): array|bool
    {
