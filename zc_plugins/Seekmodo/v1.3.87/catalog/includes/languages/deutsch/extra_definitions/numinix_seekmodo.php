<?php
/**
 * Seekmodo language definitions (deutsch).
 *
 * Zen Cart 1.5.7-compatible define() file.
 */

if (!defined('TEXT_SEEKMODO_SUGGEST_RECENT')) {
    define('TEXT_SEEKMODO_SUGGEST_RECENT', 'Zuletzt gesucht');
}
...
if (!defined('TEXT_SEEKMODO_SUGGEST_CATEGORIES')) {
    define('TEXT_SEEKMODO_SUGGEST_CATEGORIES', 'Kategorien');
}
if (!defined('TEXT_SEEKMODO_SUGGEST_REDIRECTS')) {
    define('TEXT_SEEKMODO_SUGGEST_REDIRECTS', 'Weiterleitungen');
}
if (!defined('TEXT_SEEKMODO_SUGGEST_DID_YOU_MEAN')) {
    define('TEXT_SEEKMODO_SUGGEST_DID_YOU_MEAN', 'Meinten Sie');
}
...
if (!defined('TEXT_SEEKMODO_SUGGEST_CATEGORY_FILTER')) {
    define('TEXT_SEEKMODO_SUGGEST_CATEGORY_FILTER', 'Kategorie');
}

if (!defined('TEXT_SEEKMODO_SUGGEST_RELATED')) {
    define('TEXT_SEEKMODO_SUGGEST_RELATED', 'Verwandt');
}

if (!defined('TEXT_SEEKMODO_SUGGEST_TRY')) {
    define('TEXT_SEEKMODO_SUGGEST_TRY', 'Versuchen');
}

if (!defined('TEXT_SEEKMODO_SUGGEST_PAGE')) {
    define('TEXT_SEEKMODO_SUGGEST_PAGE', 'Seite');
}

if (!defined('TEXT_SEEKMODO_SUGGEST_ARTICLE')) {
    define('TEXT_SEEKMODO_SUGGEST_ARTICLE', 'Artikel');
}
...
if (!defined('TEXT_SEEKMODO_RECO_PDP_ALSO_BOUGHT')) {
    define('TEXT_SEEKMODO_RECO_PDP_ALSO_BOUGHT', 'Kunden kauften auch');
}
...
if (!defined('TEXT_SEEKMODO_RECO_CATEGORY_TRENDING')) {
    define('TEXT_SEEKMODO_RECO_CATEGORY_TRENDING', 'Trends in dieser Kategorie');
}
if (!defined('TEXT_SEEKMODO_RECO_POPULAR')) {
    define('TEXT_SEEKMODO_RECO_POPULAR', 'Beliebt in dieser Kategorie');
}
