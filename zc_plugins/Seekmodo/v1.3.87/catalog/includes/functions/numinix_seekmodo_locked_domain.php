...
if (!function_exists('numinix_seekmodo_can_index')) {
    ...
    function numinix_seekmodo_can_index(): bool
    {
        ...
        if ($locked !== '') {
            ...
            // Current host is the locked domain. Allow even when that
            // host looks nonprod — operators who lock a tenant to
            // demo/staging (e.g. kip-demo) intend that host to own
            // the index. Unlocked nonprod hosts stay fail-closed below.
            return true;
        }
