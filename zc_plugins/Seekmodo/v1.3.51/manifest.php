...
return [
    ...
    'changelog' => 'v1.3.51 (2026-08-10): Unpaid / trial_expired suggest falls back to Enhanced Native locally (no hung gateway dropdown). See CHANGELOG.md.',
