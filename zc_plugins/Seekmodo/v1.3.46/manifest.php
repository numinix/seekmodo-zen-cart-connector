...
return [
    ...
    'changelog' => 'v1.3.46 (2026-08-04): German-primary stores no longer show English suggest chrome (init + label pack race; NS-26042). Includes v1.3.45 exact-part empty suggest. See CHANGELOG.md.',
