...
return [
    ...
    'changelog' => 'v1.3.45 (2026-08-04): Exact-part empty suggest alignment (AKS 1.7.6) — gate suggest to products/categories + clear REST keywords on zero-hit exact SKU tokens (e.g. 4-6340-20). - v1.3.44 (2026-08-03): Exact model/sku filter for hyphenated part tokens. See CHANGELOG.md for earlier releases.',
