...
return [
    ...
    'changelog' => 'v1.3.67 (2026-08-17): Drain Zen Cart QueryCache during catalog push so unique keyset pages and per-product category SELECTs cannot retain mysqli results until OOM. Prefetch products_to_categories per page. See CHANGELOG.md.',
