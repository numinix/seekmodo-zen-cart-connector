...
return [
    ...
    'changelog' => 'v1.3.44 (2026-08-03): Exact model/sku filter for hyphenated part tokens (AKS looksLikeExactPartToken parity, incl. 4-6340-20) so drop_tokens cannot dump irrelevant SERP hits on a miss. - v1.3.43 (2026-08-03): Numeric search matches products_id OR exact model/sku (RED-1862). See CHANGELOG.md for earlier releases.',
