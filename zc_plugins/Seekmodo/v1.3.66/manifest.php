...
return [
    ...
    'changelog' => 'v1.3.66 (2026-08-15): SERP click beacon pidFromHref no longer drops product links that carry a breadcrumb ?cPath= (Numinix listing URLs). Still rejects -c-N category slugs and trailing-slash /slug-{id}/ category rewrites. See CHANGELOG.md.',
