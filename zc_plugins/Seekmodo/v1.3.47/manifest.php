...
return [
    ...
    'changelog' => 'v1.3.47 (2026-08-07): CLI indexer uses HTTPS_SERVER when HTTPS_CATALOG_SERVER is unset (fixes stalled catalog sync). Suggest PHP path sends serp_passthrough for SERP parity. See CHANGELOG.md.',
