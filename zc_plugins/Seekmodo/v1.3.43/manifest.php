...
return [
    ...
    'changelog' => 'v1.3.43 (2026-08-03): Numeric search matches products_id OR exact model/sku so digit-only model numbers (e.g. Redline 4826) rank correctly (RED-1862). - v1.3.42 (2026-08-02): Drop wget/curl/CLI conversion mirrors; sm_ltr cookie keeps search_event_id across login for buy-now LTR labels. See CHANGELOG.md for earlier releases.',
