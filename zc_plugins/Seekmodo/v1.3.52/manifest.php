...
return [
    ...
    'changelog' => 'v1.3.52 (2026-08-10): Soft + dismissible admin billing notices for trial/quota/paused (Enhanced Native is fine). See CHANGELOG.md.',
