...
return [
    ...
    'changelog' => 'v1.3.69 (2026-08-17): Default storefront suggest to the subscribed split-rail widget; install NUMINIX_SEEKMODO_SUGGEST_USE_LEGACY=false and reset leftover true. See CHANGELOG.md.',
