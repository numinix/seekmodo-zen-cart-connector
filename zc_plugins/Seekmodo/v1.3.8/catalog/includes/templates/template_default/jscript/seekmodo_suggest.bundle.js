...
`,Z=.15,ee=.85,Re=.28,te="seekmodo:split-rail-mobile-ratio-v3",Ae="(max-width: 900px)",Te=1-Re;function Ce(){return a("div",{class:"split-divider",part:"split-divider",html:'<svg class="split-divider-icon" viewBox="0 0 36 12" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="1" width="24" height="2" rx="1" fill="currentColor"/><rect x="6" y="5" width="24" height="2" rx="1" fill="currentColor"/><rect x="6" y="9" width="24" height="2" rx="1" fill="currentColor"/></svg>'})}function oe(n){let e=n.querySelector(".split-divider");if(!e)return ()=>{};let t=window.matchMedia(Ae),r=Te;try{let m=sessionStorage.getItem(te);if(m){let c=parseFloat(m);c>=Z&&c<=ee&&(r=c);}}catch{}let o=m=>{r=Math.min(ee,Math.max(Z,m)),n.style.setProperty("--split-rail-bottom-grow",String(r)),n.style.setProperty("--split-rail-top-grow",String(1-r));},i=()=>{n.style.removeProperty("--split-rail-top-grow"),n.style.removeProperty("--split-rail-bottom-grow");},s=()=>{t.matches?o(r):i();};s();let p=false,g=0,d=r,h=m=>{!t.matches||m.button!==0||(p=true,g=m.clientY,d=r,e.classList.add("is-dragging"),e.setPointerCapture(m.pointerId),m.preventDefault());},l=m=>{if(!p)return;let f=n.getBoundingClientRect().height-e.offsetHeight;f<=0||o(d+(m.clientY-g)/f);},u=m=>{if(p){p=false,e.classList.remove("is-dragging");try{e.releasePointerCapture(m.pointerId);}catch{}try{sessionStorage.setItem(te,String(r));}catch{}}};return e.setAttribute("role","separator"),e.setAttribute("aria-orientation","horizontal"),e.setAttribute("aria-label","Resize product and suggestion panels"),e.setAttribute("tabindex","0"),e.addEventListener("pointerdown",h),e.addEventListener("pointermove",l),e.addEventListener("pointerup",u),e.addEventListener("pointercancel",u),t.addEventListener("change",s),()=>{e.removeEventListener("pointerdown",h),e.removeEventListener("pointermove",l),e.removeEventListener("pointerup",u),e.removeEventListener("pointercancel",u),t.removeEventListener("change",s),e.classList.remove("is-dragging"),i();}}var Me="https://seekmodo.com/email-assets/seekmodo-lockup.png";function ie(n){return String(n.name??n.title??"").trim()}function se(n,e,t){e.productTitleTooltip&&t&&n.setAttribute("title",t);}function ae(n,e){return n.productTitleTooltip&&e?e:""}function le(n,e,t){let r={block:"products",data:e,value:String(e.name??e.title??""),id:e.id!==void 0?String(e.id):void 0},o=n.rows.length;return n.rows.push(r),o}function He(n,e,t){let r=a("div",{class:"thumb-frame",part:"thumb-frame"}),o=z(n);return o?r.append(a("img",{class:"thumb",part:"thumb",attrs:{src:o,alt:ae(e,t),loading:"eager",decoding:"async"}})):r.append(a("div",{class:"thumb-empty",part:"thumb thumb--empty"})),r}function Ie(n,e,t){let r=z(n);return r?a("img",{class:"thumb",part:"thumb",attrs:{src:r,alt:ae(e,t),loading:"eager",decoding:"async"}}):a("div",{class:"thumb-empty",part:"thumb thumb--empty"})}function de(n,e,t="card-price"){if(n.price===void 0||n.price===null)return null;let r=a("div",{class:t,part:"price"});return n.on_sale&&typeof n.sale_price=="number"?(r.append(a("del",{text:e.formatPrice(n.price,n.currency)})),r.append(document.createTextNode(e.formatPrice(n.sale_price,n.currency)))):r.append(document.createTextNode(e.formatPrice(n.price,n.currency))),r}function ce(n,e,t){n.classList.add("row"),n.setAttribute("data-seekmodo-surface","suggest"),n.setAttribute("data-seekmodo-block","products"),n.setAttribute("data-seekmodo-pos",String(t));let r=e.rows[t];r?.id&&n.setAttribute("data-seekmodo-id",r.id),n.addEventListener("click",()=>e.onRowClick(t));}function Pe(n,e,t,r=false){let o=le(n,e),i=ie(e),s=a("button",{class:"product-card",part:"row",type:"button"});s.append(He(e,n,i));let p=a("span",{class:"card-title",part:"name",text:i});se(p,n,i),s.append(p);let g=de(e,n,"card-price");return g&&s.append(g),ce(s,n,o),s}function ze(n,e,t,r){let o=le(n,e),i=ie(e),s=a("button",{class:"hero-card",part:"row",type:"button"});r&&s.append(a("span",{class:"hero-badge",text:r})),s.append(Ie(e,n,i));let p=a("div",{class:"hero-info"}),g=a("span",{class:"card-title",part:"name",text:i});se(g,n,i),p.append(g);let d=de(e,n);return d&&p.append(d),s.append(p),ce(s,n,o),s}function D(n){let e=n.res.meta?.total??0,t=a("div",{class:"meta-bar",part:"meta-bar"}),r=a("div");r.append(a("span",{class:"count",text:`${e} results for `})),r.append(a("span",{class:"query",text:`"${n.lastQuery}"`})),t.append(r);let o=a("a",{class:"view-all view-all-cta",part:"view-all",attrs:{href:n.viewAllHref},text:n.label("view_all").replace("{total}",String(e))});return o.addEventListener("click",i=>{i.preventDefault(),n.onViewAll();}),t.append(o),t}function De(n){let e=n.res.did_you_mean;if(!e)return null;let t=a("div",{class:"did-you-mean-bar",part:"did-you-mean"});t.append(document.createTextNode(`Showing results for "${n.lastQuery}". Search instead for `));let r=a("button",{class:"swap",type:"button",text:e}),o=n.rows.length;return n.rows.push({block:"did_you_mean",data:{value:e},value:e}),r.addEventListener("click",()=>n.onRowClick(o)),t.append(r),t.append(document.createTextNode("?")),t}function O(n,e){let t=a("div",{class:"chip-row filter-bar",part:"filter-bar"});return t.append(a("span",{class:"filter-label",text:"Category"})),e.forEach((r,o)=>{let i=a("button",{class:`chip${o===0?" active":""}`,type:"button",text:`${r.name}${typeof r.count=="number"?` ${r.count}`:""}`}),s=n.rows.length;n.rows.push({block:"categories",data:r,value:String(r.name??"")}),i.addEventListener("click",()=>n.onRowClick(s)),t.append(i);}),t}function re(n,e,t="Try"){let r=a("div",{class:"chip-row",part:"filter-bar"});return r.append(a("span",{class:"filter-label",text:t})),e.forEach(o=>{let i=a("button",{class:"chip",type:"button",text:o.keyword}),s=n.rows.length;n.rows.push({block:"keywords",data:o,value:o.keyword}),i.addEventListener("click",()=>n.onRowClick(s)),r.append(i);}),r}function B(n,e,t,r,o){let i=n.rows.length;n.rows.push({block:e,data:t,value:r});let s=a("button",{class:"row",part:"row",type:"button"});return s.append(a("div",{class:"name",part:"name",text:r})),o&&s.append(a("span",{class:"badge",part:"badge",text:o})),s.setAttribute("data-seekmodo-surface","suggest"),s.setAttribute("data-seekmodo-block",e),s.setAttribute("data-seekmodo-pos",String(i)),s.addEventListener("click",()=>n.onRowClick(i)),s}function $(n,e){if(e.length===0)return null;let t=a("div",{class:"rail-section"});return t.append(a("div",{class:"group-title",part:"group-title",text:n})),e.forEach(r=>t.append(r)),t}function Oe(n){if(!n.showBranding)return null;let e=a("a",{class:"brand-footer",part:"brand-footer",attrs:{href:n.brandUrl,target:"_blank",rel:"noopener noreferrer"}});return e.append(a("span",{class:"brand-by",text:"Powered by "})),e.append(a("img",{class:"brand-logo",part:"brand-logo",attrs:{src:n.brandLogoUrl||Me,alt:"Seekmodo",height:"16"}})),e}function E(n,e,t){let r=a("div",{class:`product-grid cols-${t}`,part:"product-grid"});return e.forEach((o,i)=>r.append(Pe(n,o,i,true))),r}function ue(n,e){let t=["wrap","wide"];n==="split-rail"&&t.push("split-rail-panel"),e.splitMobileResize&&t.push("split-rail-mobile"),e.productTitleTooltip&&t.push("product-title-tooltip");let r=a("div",{class:t.join(" "),part:"wrap"});r.append(a("slot",{attrs:{name:"header"}}));let o=(e.res.products??[]).slice(0,T(n,e.limit)),i=(e.res.keywords??[]).slice(0,e.limit),s=(e.res.categories??[]).slice(0,e.limit),p=(e.res.recent??[]).slice(0,5);(e.res.trending??[]).slice(0,5);if(n==="split-rail"){r.append(D(e));let h=e.splitMobileResize?"split-body split-body--mobile-resize":"split-body",l=a("div",{class:h}),u=a("aside",{class:"rail",part:"rail"}),m=i.map(y=>B(e,"keywords",y,y.keyword)),c=$(e.label("keywords"),m);c&&u.append(c);let f=p.map(y=>B(e,"recent",y,y.keyword)),b=$(e.label("recent"),f);b&&u.append(b);let P=s.map(y=>B(e,"categories",y,String(y.name),typeof y.count=="number"?String(y.count):void 0)),S=$(e.label("categories"),P);S&&u.append(S);let U=a("div",{class:"canvas"});U.append(E(e,o,5)),l.append(U),e.splitMobileResize&&l.append(Ce()),l.append(u),r.append(l);}else if(n==="cinema-grid"){let h=De(e);h&&r.append(h),r.append(D(e)),s.length&&r.append(O(e,s)),i.length&&r.append(re(e,i));let l=a("div",{class:"canvas"});l.append(E(e,o,6)),r.append(l);}else if(n==="command-bar"){let h=e.res.meta?.total??0,l=a("div",{class:"command-header",part:"meta-bar"});l.append(a("div",{class:"query-display",text:`"${e.lastQuery}"`})),l.append(a("span",{class:"result-pill",text:`${h} products`}));let u=a("a",{class:"view-all-link",part:"view-all",attrs:{href:e.viewAllHref},text:"View all \u2192"});if(u.addEventListener("click",c=>{c.preventDefault(),e.onViewAll();}),l.append(u),r.append(l),e.res.did_you_mean){let c=a("div",{class:"chip-row"});c.append(a("span",{class:"filter-label",text:"Did you mean"}));let f=a("button",{class:"chip",type:"button",text:e.res.did_you_mean}),b=e.rows.length;e.rows.push({block:"did_you_mean",data:{value:e.res.did_you_mean},value:e.res.did_you_mean}),f.addEventListener("click",()=>e.onRowClick(b)),c.append(f),r.append(c);}i.length&&r.append(re(e,i,"Related")),s.length&&r.append(O(e,s));let m=a("div",{class:"canvas"});m.append(E(e,o,5)),r.append(m);}else if(n==="magazine"){r.append(D(e)),s.length&&r.append(O(e,s));let h=a("div",{class:"canvas"}),l=o.slice(0,3),u=o.slice(3);if(l.length){h.append(a("div",{class:"group-title",part:"group-title",text:"Best matches"}));let m=a("div",{class:"hero-row",part:"hero-row"});l.forEach((c,f)=>{m.append(ze(e,c,f,f===0?"Top match":void 0));}),h.append(m);}u.length?(h.append(a("div",{class:"group-title",part:"group-title",text:"More results"})),h.append(E(e,u,6))):l.length||h.append(E(e,o,6)),r.append(h);}let d=Oe(e);return d&&r.append(d),r.append(a("slot",{attrs:{name:"footer"}})),r}function C(n){return n!=="classic"&&n!==""}var pe=["recent","did_you_mean","keywords","trending","products","categories"],Be={recent:"Recently searched",trending:"Trending",keywords:"Suggestions",products:"Products",categories:"Categories",did_you_mean:"Did you mean",view_all:"View all {total} results",empty:"No matches yet \u2014 keep typing.",cors_blocked:A},he=`
  :host {
