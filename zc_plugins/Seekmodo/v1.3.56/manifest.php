...
return [
    ...
    'changelog' => 'v1.3.56 (2026-08-12): Paginate catalog push SQL so Zen Cart queryFactory no longer OOM-buffers the full product table. See CHANGELOG.md.',
