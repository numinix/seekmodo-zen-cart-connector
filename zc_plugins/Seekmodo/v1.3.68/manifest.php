...
return [
    ...
    'changelog' => 'v1.3.68 (2026-08-17): Strip Zen Cart productBasePrice HTML from typeahead/suggest prices so tags are not shown as text. See CHANGELOG.md.',
