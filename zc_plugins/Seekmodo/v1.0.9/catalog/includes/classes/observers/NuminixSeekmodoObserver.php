...
class NuminixSeekmodoObserver extends \base
{
     ...
     * arrives on a product page from a SERP we just rendered, fire
     * a click beacon. Detection is two-pronged:
     *
     *   1. The session position-map carries the products_id (the
     *      observer rewrote a gateway-driven SERP earlier in this
     *      session).
     *   2. The HTTP_REFERER points at the search-results page on
     *      this storefront.
     *
     * Both must hold before we attribute the visit as a click. A
     * shopper deep-linking into a product or arriving from an external
     * search engine should NOT generate a click beacon.
     */
